  ...
  <div class="row">
    <form class="" action="/expense/create" method="post">
      ...
      <div class="col-md-6">
        ...
        <!-- Selezione dei rimborsi fatturati -->
        <div class="reimbursables">
          <?php dbga($reimbursables); ?>
          <ul>
            <?php foreach($reimbursables as $i => $r){ ?>
            <li>
              <div class="form-group">
                <label for="reimbursable-<?php echo $i; ?>">
                  <input type="checkbox" value="<?php echo $r->idexpense; ?>" name="reimbursable[]">
                  <?php echo $r->reimburser . ' : ' . $r->amount; ?>
                </label>
              </div>
            </li>
            <?php } ?>
